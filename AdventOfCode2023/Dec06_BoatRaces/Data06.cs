namespace AdventOfCode2023.Dec06
{
    ...
    // a large pile of sand somewhere near here, but you don't see anything besides lots of water and
    ...
    // - they're actually toy boats, each with a big button on top. Holding down the button charges the boat,
    // and releasing the button allows the boat to move. Boats move faster if their button was held longer,
    // but time spent holding the button counts against the total race time. You can only hold the button at
    ...
    // for 71530 milliseconds and the record distance you need to beat is 940200 millimeters.
    ...
    public class Data06
    {
        public static List<Race> RacesOne => new()
        {
            new Race(60, 601),
            new Race(80, 1163),
            new Race(86, 1559),
        ...
        public static Race RaceTwo => new Race(60808676, 601116315591300);
    }
