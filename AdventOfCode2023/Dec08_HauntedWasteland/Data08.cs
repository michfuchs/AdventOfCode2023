...
namespace AdventOfCode2023.Dec08
{
    ...
    // how to navigate the desert.At least, you're pretty sure that's what they are; one of the documents contains a list
    ...
    public static class Data08
    {
        public static string Instructions = "";
        public static List<Data08Plot> DesertPlots = Lines.Select(l => new Data08Plot(l.Substring(0, 3), l.Substring(7, 3), l.Substring(12, 3))).ToList();
    ...
    public struct Data08Plot
    {
        public string Name { get; }
        public string Left { get; }
        public string Right { get; }

        public bool IsStartPlot { get; }
        public bool IsEndPlot { get; }

        public Data08Plot(string name, string left, string right)
        {
            Name = name;
            Left = left;
            Right = right;

            IsStartPlot = name.EndsWith("Z");
            IsEndPlot = name.EndsWith("Z");
        }
    }
}
