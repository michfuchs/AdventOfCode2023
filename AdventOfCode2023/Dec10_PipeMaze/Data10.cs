namespace AdventOfCode2023.Dec10
{
    public static class Data10
    {
        ...
        // you notice something metallic scurry away in your peripheral vision and jump into a big pipe! It didn't look
        // like any animal you've ever seen; if you want a better look, you'll need to get ahead of it.
        ...
        public static List<string> Pipes = new()
        {
        ...
        public static int MapWidth => Pipes[0].Length;
        public static int MapHeight = Pipes.Count;

    }
    public class Data10Pipe
    {
        public char C { get; set; }
        public int X { get; }
        public int Y { get; }
        public bool IsMainLoop { get; set; }
        public Data10Dir Dir { get; internal set; }

        public Data10Pipe(char c, int x, int y)
        {
            C = c;
            X = x;
            Y = y;
