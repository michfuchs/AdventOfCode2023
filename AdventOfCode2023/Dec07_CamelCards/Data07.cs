namespace AdventOfCode2023.Dec07
{
    ...
    // multiplied by its rank, where the weakest hand gets rank 1, the second-weakest hand gets rank 2,
    // and so on up to the strongest hand.Because there are five hands in this example, the strongest hand will have rank 5
    ...
    public class Data07
    {
        public static List<Hand> Hands => Lines.Select(i => new Hand(i.Split(" ")[0], int.Parse(i.Split(" ")[1]))).ToList();
    ...
    public class Hand
    {
        ...
        /// <summary>
        /// First criteria:
        /// 5 of a kind = 7, 4 of the kind = 6, full house = 5, 3 of a kind = 4, 2 pair = 3, 1 pair = 2, else = 1
        /// </summary>
        public int Type { get; set; }
        /// <summary>
        /// Second criteria: value depending on sequence of cards
        /// </summary>
